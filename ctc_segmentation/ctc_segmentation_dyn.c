...
static PyObject *__pyx_pf_16ctc_segmentation_20ctc_segmentation_dyn_cython_fill_table(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_table, PyArrayObject *__pyx_v_lpz, PyArrayObject *__pyx_v_ground_truth, PyArrayObject *__pyx_v_offsets, int __pyx_v_blank, int __pyx_v_flags) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ground_truth.rcbuffer->pybuffer, (PyObject*)__pyx_v_ground_truth, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 20, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_offsets.rcbuffer->pybuffer, (PyObject*)__pyx_v_offsets, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 20, __pyx_L1_error)
  }
 ...
 */
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int64); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 47, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_cur_offset.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
          /*else*/ {
            ...
            } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_table.diminfo[0].shape)) __pyx_t_26 = 0;
            if (__pyx_t_13 < 0) {
              __pyx_t_13 += __pyx_pybuffernd_table.diminfo[1].shape;
 ...
 */
      /*else*/ {
        ...
        if (__pyx_t_12 < 0) {
          __pyx_t_12 += __pyx_pybuffernd_lpz.diminfo[1].shape;
